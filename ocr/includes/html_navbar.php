...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-2">
  <a class="navbar-brand" href="./fileviewer.php"><img src='./images/logo.jpg' width='200'></a> 
      ...
      <li class="nav-item active">
        <a class="nav-link mainmenu" href="./cron_archive.php">
          <i class="fa fa-play"></i> Archive Exports <span class="sr-only">(current)</span></a>
            ...
            <!-- <p class='alert alert-success'>New features are now available for use. <a href='./upgradenotes.php'>Learn more...</a></p> -->
<?php
